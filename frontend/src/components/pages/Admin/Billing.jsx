...
export default function Billing() {
  ...
  const addMedicine = () => {
    ...
    const exists = items.find(
      (item) => item.medicineId === selectedMedicineObj._id,
    );
    if (exists) {
    ...
    <div className="space-y-6">
          ...
          <div className="mt-5 rounded-xl border border-stone-200 bg-white p-4">
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-stone-500">Available balance</p>
              </div>
      ...
      <div className="overflow-visible rounded-2xl border border-stone-200 bg-[#faf9f6] p-5 shadow-sm">
        <div className="mb-5 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            <h2 className="text-lg font-semibold text-stone-900">Medicines</h2>
      ...
      <div className="rounded-2xl border border-stone-200 bg-[#faf9f6] p-6 shadow-sm">
        ...
        <div className="mx-auto max-w-xl">
          ...
          <button
            onClick={handleGenerateBill}
            disabled={loading}
            className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-stone-900 py-3 text-sm font-medium text-white shadow-sm transition hover:bg-stone-800 hover:shadow-md disabled:cursor-not-allowed disabled:opacity-60"
          >
            {loading && (
